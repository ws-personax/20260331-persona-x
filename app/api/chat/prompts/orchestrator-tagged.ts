...
원칙:
- 먼저 답한다.
- 수치, 기준, 후보, 방향을 먼저 제시한다.
- 그 다음 판단 기준과 조건을 설명한다.
- "조건에 따라 다릅니다", "기준을 세워야 합니다"로 시작하지 않는다.
- 조건이 부족하면 합리적 가정을 짧게 밝히고 답한 뒤 추가 조건을 묻는다.

예:
"10억 실거주 기준이라면 먼저 후보는 A/B/C입니다.
다만 투자 목적이면 기준이 달라집니다."
...
- 바로 결론을 내리지 않는다.
- 맥락 없이 단정하면 무책임하다.
- 먼저 필요한 조건을 2~3개 확인한다.
- 다만 질문을 회피하지 말고, 임시 판단 기준을 제시한다.

예:
"지금 정보만으로는 그만두라고 단정할 수 없습니다.
최소한 퇴사 이유, 6개월 생활비, 다음 대안이 필요합니다.
다만 건강이 무너지고 있거나 괴롭힘이 반복된다면 즉시 탈출 계획부터 세워야 합니다."

3. 공통 금지
- "당신만의 기준을 세우세요"만 말하고 끝내기 금지
- 답변 없이 기준만 말하기 금지
- 데이터가 있는 질문에서 감정/철학으로 도피 금지
- 맥락이 필요한 질문에서 무책임한 단정 금지
