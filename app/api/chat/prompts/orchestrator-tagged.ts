...
유저 질문 1개에 대해 RAY/JACK/LUCIA 3명 + ECHO 1명의 1라운드 대사를 한 번에 작성합니다.${buildStage1Section(stage1Data)}${buildFirstPersonaRuleSection(firstPersona, categoryV3, hasPriorConversation)}${buildCategoryVocabBlockRule(categoryV3)}
...
${needsLuciaClose ? '\n[LUCIA_CLOSE]\n{1줄: LUCIA의 따뜻한 마무리}\n{1줄: 유저에게 부담 없는 작은 질문}' : ''}
${buildFirstPersonaRuleSection(firstPersona, categoryV3, hasPriorConversation)}${buildCategoryVocabBlockRule(categoryV3)}`;
};
