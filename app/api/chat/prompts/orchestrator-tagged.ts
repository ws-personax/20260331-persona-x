...
🚨 질문 형식 절대 규칙:
- 3명 발언에서 유저가 아직 답하지 않은 구체적 전제 1개를 찌를 것.
- 숫자 또는 양자택일(A예요, B예요?)로 끝낼 것.
- ⛔ "준비가 되어 있나요" "감수할 자신이 있나요" "각오는 되어 있나요" 류 추상·태도 질문 절대 금지.
- ⛔ "무엇이 다르다고 보세요" "어떻게 생각하세요" 류 열린 추상 질문 절대 금지.
- ⛔ "왜 ~인가요" 동기 질문도 금지 — 사실 확인/선택 질문만 허용.

✅ 예시 1 (투자):
"...... 손절선 240,000원 잡아놓으셨어요, 아직이에요?"
✅ 예시 2 (투자):
"...... 지금 들고 있어요, 없어요?"
✅ 예시 3 (투자):
"...... 3개월 버틸 수 있어요, 없어요?"
...
"...... 이직하면 연봉 올라요, 내려가요?"
✅ 예시 5 (감정):
"...... 지금 더 무거운 게 돈이에요, 자존심이에요?"
✅ 예시 6 (원칙):
"...... 1년 후에 이 결정 후회할 것 같아요, 아니에요?"
...
const CATEGORY_V3_KEYWORDS: Record<CategoryV3, RegExp> = {
  invest: /주식|투자|돈|종목|ETF|펀드|부동산|코인|비트코인|매수|매도|배당|환율|금리|수익|손실|포트폴리오|매도|매수|상승|하락|올랐|떨어|물렸|삼성전자|SK하이닉스|테슬라|애플|엔비디아|코스피|코스닥|나스닥|S&P|퇴직금|연금|적금|예금|넣어야|넣을까|어디에 넣/,
  action: /퇴사|이직|결단|결정|도전|스포츠|야구|축구|농구|골프|경기|승부|선수|이길|우승|시작할|그만둘|바꿀|옮길|뛰어들|승부|뛸까|명퇴|명예퇴직|희망퇴직|권고사직|퇴직 권유/,
  emotional: /감정|관계|일상|걱정|가족|경사|좋은소식|기쁜|슬프|우울|불안|외로|힘들|지쳐|피곤|마음|위로|공감|가족|부모|자녀|남편|아내|친구|동료|선배|후배|시댁|처가|결혼|이혼|아이|손주|손자|손녀|기뻐|기쁘|설레|행복|축하|경사|반가|잠이|잠 못|잠을 못|못 자|수면|불면|속상|속상해|속상하|아파|아프|강아지|반려동물|반려견|반려묘|고양이|반려/,
