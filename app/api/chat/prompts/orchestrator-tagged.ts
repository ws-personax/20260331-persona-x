...
const buildFirstPersonaRuleSection = (
...
## 🚀 FIRST 페르소나 행동 규칙 (이번 라운드 [FIRST] 블록 작성자)
카테고리(${cat}) 기준 FIRST 권장 페르소나: ${name}
...
유저 질문 1개에 대해 RAY/JACK/LUCIA 3명 + ECHO 1명의 1라운드 대사를 한 번에 작성합니다.${buildStage1Section(stage1Data)}${buildFirstPersonaRuleSection(firstPersona, categoryV3)}
