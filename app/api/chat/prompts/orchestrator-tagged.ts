...
□ 위 3개 예시의 **종목명·수치(PBR 1.1배, 외국인 12조, 청산가치, 재취업률 23%, 14개월, 67%, 발생률 47%, 8.4년, 2.3배, "주간보호센터" 등)를 유저가 묻지 않은 맥락에 끌어오지 않았는가**?
□ 위 3개 예시의 **1·2라운드 형식 그대로 출력하지 않고** [FIRST]→[SECOND]→[THIRD]→[CLOSER] 4블록으로 압축했는가?
