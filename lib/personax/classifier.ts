...
const CATEGORY_V3_KEYWORDS: Record<CategoryV3, RegExp> = {
  invest: /주식|투자|종목|ETF|펀드|부동산|코인|비트코인|XRP|xrp|리플|이더리움|ETH|eth|솔라나|SOL|sol|매수|매도|배당|환율|금리|수익|손실|포트폴리오|매도|매수|상승|하락|올랐|떨어|물렸|삼성전자|LG전자|엘지전자|SK하이닉스|테슬라|애플|엔비디아|코스피|코스닥|나스닥|S&P|퇴직금|연금|적금|예금|사야|살까|넣어야|넣을까|어디에 넣|노후 자금|노후자금|은퇴 자금|은퇴자금|자금이 부족|자금 부족/,
  ...
  principle: /인생|원칙|철학|판단|방향|의미|가치|본질|삶|살아간|어떻게 살|어떻게 사|왜 사|왜 살|잘 사|잘 살아|사는 게|사는 거|사는 길|살아가|살아간|어떤 사람|어떤 길|선택의 기준|무엇이 옳|옳은가|맞는가|진리|진정|정답이 뭐|인생 정답|삶의 정답|AI 때문|직업 없어|직업이 없어|일자리 없어|일 없어질|일 사라질|직업 사라|일자리 사라|사랑|우정|성공|정의|뜻|개념/,
