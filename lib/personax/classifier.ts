...
const CATEGORY_V3_KEYWORDS: Record<CategoryV3, RegExp> = {
  invest: /주식|투자|돈|종목|ETF|펀드|부동산|코인|비트코인|매수|매도|배당|환율|금리|수익|손실|포트폴리오|매도|매수|상승|하락|올랐|떨어|물렸|삼성전자|LG전자|엘지전자|SK하이닉스|테슬라|애플|엔비디아|코스피|코스닥|나스닥|S&P|퇴직금|연금|적금|예금|사야|살까|넣어야|넣을까|어디에 넣|노후 자금|노후자금|은퇴 자금|은퇴자금|자금이 부족|자금 부족/,
