# PersonaX Core Definition (V2)

PersonaX는 답을 주는 AI가 아니라

결정을 통해 나를 이해하고
시간을 통해 나를 다시 보게 만드는 AI다.
...
Personal Memory
= 나는 어떤 사람인가를 시간을 통해 발견하는 것

## 제품 우선순위 판단 기준

새로운 기능이나 리팩토링을 수행할 때
항상 아래 질문을 먼저 확인한다.

1. 사용자가 "나를 이해받았다"고 느끼게 하는가?

2. 사용자가 "내가 어떤 사람인지" 발견하게 하는가?

3. 사용자가 "내가 여기까지 왔구나"를 느끼게 하는가?

4. 사용자가 "다음 결정을 더 잘" 하게 만드는가?
...
History는 저장 기능이 아니다.
사용자의 결정 여정을 보여주는 기능이다.

Review Card는 알림 기능이 아니다.
과거의 내가 현재의 나에게 보내는 편지다.

Personal Memory는 사용자 정보를 저장하는 기능이 아니다.
시간을 통해 사용자가 자기 자신을 발견하게 만드는 기능이다.
#  비용 폭주 방지 원칙 (최우선)
